...
results = bus.read_i2c_block_data(0x21,0xE0) # 0xE0 for MO4 sensor connected to VIN7 channel of ADC with I2C Address 0x21
...
print "ADC Results from MO4 sensor:"
print results
sensordata = []
...
mydata=[('sensor','gm_mo4'),('value',dataValue)]    #The first is the var name the second is the value

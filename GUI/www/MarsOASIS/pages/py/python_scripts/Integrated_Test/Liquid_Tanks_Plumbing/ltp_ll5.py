...
results = bus.read_i2c_block_data(0x22,0xF0) # 0xF0 for LL5 sensor connected to VIN8 channel of ADC with I2C Address 0x22
...
print "ADC Results from LL sensor on LL5 channel:"
print results
sensordata = []
...
mydata=[('sensor','ltp_ll5'),('value',dataValue)]    #The first is the var name the second is the value

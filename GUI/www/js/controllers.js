...
.controller('overviewCtrl', ["$scope", "Tanks", function($scope, Tanks) {
  ...
  // console.log(Tanks('S103').data);

  // XMLHttp Request to grab JSON file.
  // var readings;
  // $http({ method: 'GET', url: 'https://cumarsoasis.firebaseio.com/data/sensors/internal_atmosphere/S305.json' }).then(function successCallback(response) {
  //     readings = response;

...
def init_sensor_hash_table():
    sensor_hash_table['DO_1']=np.arange(0,10,1, dtype=np.object)
    ...
    sensor_hash_table['LL_7']=np.arange(0,10,1, dtype=np.object)
    ...
    sensor_hash_table['RHT_1_TEMP']=np.arange(0,10,1, dtype=np.object)
    sensor_hash_table['RHT_2']=np.arange(0,10,1, dtype=np.object)
    sensor_hash_table['RHT_2_TEMP']=np.arange(0,10,1, dtype=np.object)
    sensor_hash_table['RHT_3']=np.arange(0,10,1, dtype=np.object)
    sensor_hash_table['RHT_3_TEMP']=np.arange(0,10,1, dtype=np.object)
    ...
    sensor_hash_table['P1']=np.arange(0,10,1, dtype=np.bool_) #Pumps and solenoids are boolean objects
    sensor_hash_table['P2']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P3']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P4']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P5']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P8']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['M1']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['M2']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P10']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['M9']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P12']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['V3']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['M8']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['V4']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P11']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P7']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['F2']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['M6']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['M7']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P6']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['P9']=np.arange(0,10,1, dtype=np.bool_)
    sensor_hash_table['ST']=np.arange(0,10,1, dtype=np.bool_)   

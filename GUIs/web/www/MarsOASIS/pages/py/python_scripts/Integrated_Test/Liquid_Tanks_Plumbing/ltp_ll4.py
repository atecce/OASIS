...
results = bus.read_i2c_block_data(0x22,0xE0) # 0xE0 for LL4 sensor connected to VIN7 channel of ADC with I2C Address 0x22
...
print "ADC Results from LL sensor on LL4 channel:"
print results
sensordata = []
...
mydata=[('sensor','ltp_ll4'),('value',dataValue)]    #The first is the var name the second is the value

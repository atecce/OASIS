...
results = bus.read_i2c_block_data(0x22,0xD0) # 0xD0 for LL6 sensor connected to VIN6 channel of ADC with I2C Address 0x22
...
print "ADC Results from LL sensor on LL6 channel:"
print results
sensordata = []
...
mydata=[('sensor','ltp_ll6'),('value',dataValue)]    #The first is the var name the second is the value

...
results = bus.read_i2c_block_data(0x22,0xC0) # 0xC0 for LL3 sensor connected to VIN5 channel of ADC with I2C Address 0x22
...
print "ADC Results from LL sensor on LL3 channel:"
print results
sensordata = []
...
mydata=[('sensor','ltp_ll3'),('value',dataValue)]    #The first is the var name the second is the value

...
def main(argv):
	...
	if   sensor_name == "EC1":	   sensor = I2C_sensor("electrical_conductivity", 0x66)
	...
	elif sensor_name == "EC2":	   sensor = I2C_sensor("electrical_conductivity", 0x64)
	...
	for i in range(readings): print i, sensor.read()
